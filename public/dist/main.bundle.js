...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_9__user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_10__appointment_service__["a" /* AppointmentService */]],
...
var AppointmentService = (function () {
    ...
    AppointmentService.prototype.getAppointments = function () {
        return this._http.get('/appointments').map(function (data) { return data.json(); }).toPromise();
    };
    AppointmentService.prototype.createAppointment = function (newAppointment) {
        return this._http.post('/appointments', newAppointment).map(function (data) { return data.json(); }).toPromise();
    };
    AppointmentService.prototype.showAppointment = function (id) {
        return this._http.get("/appointments/" + id).map(function (data) { return data.json(); }).toPromise();
    };
    AppointmentService.prototype.delete = function (id) {
        return this._http.delete("/appointments/" + id).map(function (data) { return data.json(); }).toPromise();
    };
...
var CreateComponent = (function () {
    function CreateComponent(_userService, _appointmentService, router) {
        this._userService = _userService;
        this._appointmentService = _appointmentService;
        this.router = router;
        this.currentUser = { id: '', appointments: [] };
    ...
    CreateComponent.prototype.createAppointment = function () {
        ...
        return this._appointmentService.createAppointment(this.newAppointment)
            ...
            if (appointment.errors) {
                for (var key in appointment.errors) {
                ...
                console.log(_this.newAppointment);
                _this.router.navigateByUrl('dashboard');
            }
        })
            .catch(function (err) { console.log(err); });
    };
    CreateComponent.prototype.getCurrentUser = function () {
...
CreateComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__user_service__["a" /* UserService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__appointment_service__["a" /* AppointmentService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__appointment_service__["a" /* AppointmentService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */]) === "function" && _c || Object])
], CreateComponent);
...
module.exports = "<a href (click)=\"logout()\">Logout</a>\n<h1>Doctor's Appointments</h1>\n<table>\n  <tr>\n    <th>Date</th>\n    <th>Time</th>\n    <th>Patient Name</th>\n    <th>Complaint</th>\n  </tr>\n  <tr *ngFor=\"let appointment of appointments; let idx = index\">\n    <td>{{ appointment.createdAt | date:'yMMMd' }}</td>\n    <td>{{ appointment.createdAt | date:'shortTime' }}</td>\n    <td>Can't get the user name- appointment.user.name doesn't work</td>\n    <td>{{ appointment.complaint }}<button *ngIf=\"currentUser._id == appointment.user?._id\" (click)=\"delete(appointment._id)\">Cancel</button></td>\n  </tr>\n</table>\n<button [routerLink]=\"['/create']\">Add new appointment</button>"
...
var DashboardComponent = (function () {
    function DashboardComponent(_userService, _appointmentService, router) {
        this._userService = _userService;
        this._appointmentService = _appointmentService;
        this.router = router;
        this.currentUser = { _id: 0, appointments: [] };
        this.user = {};
        this.appointments = [];
    }
    ...
    DashboardComponent.prototype.delete = function (id, idx) {
        var _this = this;
        return this._appointmentService.delete(id)
            .then(function (appointment) {
            _this.currentUser.appointments.splice(idx, 1);
        })
            .catch(function (err) { return console.log(err); });
    };
